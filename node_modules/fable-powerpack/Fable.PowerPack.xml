...
<member name="M:Fable.PowerPack.PromiseSeqModule.skip``2(System.Int32,Fable.Import.JS.Promise{Fable.PowerPack.PromiseSeqInner{``0}})">
<summary>
...
<member name="M:Fable.PowerPack.PromiseSeqModule.skipWhile``2(Microsoft.FSharp.Core.FSharpFunc{``0,System.Boolean},Fable.Import.JS.Promise{Fable.PowerPack.PromiseSeqInner{``0}})">
<summary>
...
<member name="M:Fable.PowerPack.PromiseSeqModule.skipWhileAsync``3(Microsoft.FSharp.Core.FSharpFunc{``0,``1},Fable.Import.JS.Promise{Fable.PowerPack.PromiseSeqInner{``0}})">
<summary>
 Skips elements from an asynchronous sequence while the specified
 predicate holds and then returns the rest of the sequence. The
 predicate is evaluated asynchronously.
...
<member name="M:Fable.PowerPack.PromiseSeqModule.iter``1(Microsoft.FSharp.Core.FSharpFunc{``0,Microsoft.FSharp.Core.Unit},Fable.Import.JS.Promise{Fable.PowerPack.PromiseSeqInner{``0}})">
<summary>
...
<member name="M:Fable.PowerPack.PromiseSeqModule.iterAsync``2(Microsoft.FSharp.Core.FSharpFunc{``0,``1},Fable.Import.JS.Promise{Fable.PowerPack.PromiseSeqInner{``0}})">
<summary>
...
<member name="M:Fable.PowerPack.Fetch.fetchAs``1(System.String,Microsoft.FSharp.Collections.FSharpList{Fable.PowerPack.Fetch.Fetch_types.RequestProperties})">
<summary>
